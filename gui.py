...
from storage import load_students, save_student, search_student, update_student, delete_student
...
class StudentGUI:
    ...
    def _build_widgets(self):
        ...
        ttk.Button(form, text="Add / Update", command=self._on_add_update).grid(row=1, column=5, sticky="e")
